...
<div id="expertise" class="expertise">
  <div class="pattern">
    <div class="wrap">
      ...
      <div class="title-content">Our Expertise</div>

        <div class="column one-half">
          <b>Executive Search</b>
          <p>We have access to some of the most senior executives working across the region. But we don't stop there; our objective is to find the best candidates, no matter where they are located. Having placed senior management resources in over 100 MNC's, we understand the process of search and selection to a level rarely experienced in the SE Asian market.</p>
        </div>

        <div class="column one-half">
          <b>Management Search</b>
          <p>As employees progress through an organisation, opportunities for management roles emerge and we have developed an unrivalled track record in successfully identifying and attracting mid and senior management staff that can grow within your organisation into the future executives and management team for your growing business needs.</p>
        </div>
...
<div class="bg-supply">
  <div class="one-half area-opacity">
    ...
    <p>Types of assignments include:
...
<div id="third-dimension" class="third-dimension">
<div class="wrap">

  <div class="title-content">The Third Dimension</div>

  <p class="description">RSI International Asia has devised a unique, innovative method: "The Third Dimension." We apply it to search and select the best leadership talent for your organisation.</p>

  <div class="clbrief third-dimension-column one-third">
    <p>Client Brief</p>
  </div>
  <div class="idenf third-dimension-column one-third">
    <p>Identification Process</p>
  </div>
  <div class="selection third-dimension-column one-third">
  ...
  <div class="column one-third">
    <p>To define a successful search strategy, it is important to develop a thorough understanding of the role, the corporate culture of the company and the skill sets, competencies and experience required to succeed in the job. We strive to minimize costly mishires by placing detailed emphasis on cultural, team, leadership, performance and integration assessments in ensuring a successful executive hire.</p>
    <p>Every leadership search assignment at RSI begins with an assignment brief. We carry out in-depth interviews with our clients and the decision makers involved in the hiring process. Parallel to the search assignment, we may include assessing and counseling the company\'s executive management team to optimise the hiring process. RSI International Asia uses a specific research method suited to senior management positions ensuring the successful outcome of the assignment.</p>
  </div>
  <div class="column one-third">
    <p>RSI International Asia uses specific, proven and tested research methodologies suited to senior management positions and thereby ensuring the success of each assignment:</p>
    <ul>
      <li>Candidate search and strategic mapping of target organisations.</li>
      <li>Direct search: talent pooling of our established SE Asian network, proactively keeping track of the best professionals in their field and industry.</li>
      <li>Network search: searches in our respective industry networks identifying candidates by their profiles and proven track records.</li>
    </ul>
    <p>Our proven performance is a product of targeting the very best candidates available in the market and having consistent communication with the candidates we encounter and assess. By using this methodology we can meet our clients\' requirements within agreed assignment timeframes whilst offering services, fees and conditions of payment which meet their expectations.</p>
  </div>
  <div class="column one-third">
    <p>RSI International Asia\'s consultants conduct detailed competency-based behavioural interviews to assess the experience and capability of candidates against requirements, competencies as well as considering the very important aspect of cultural fit:</p>
    <ul>
      <li>Understanding of the candidate\'s personal circumstances, motivations and broader ambitions.</li>
      <li>Analysis of the candidates resumes and defined achievements made to previous employers.</li>
      <li>Determining individual behavioural characteristics as indication of future success.</li>
    </ul>
    <p>RSI International Asia\'s consultants validate their candidate evaluation by checking professional references. In addition, if required, we can offer different assessment tools in order to assess the relevant competences of candidates.</p>
  </div>
...
<div class="contact">
  <div class="wrap">
    ...
    <div class="column one-half">
      <div class="title-content">Contact Us</div>
    ...
    <div class="column one-half">
      <div class="title-content">Our Location</div>
